...
export default function RequestToJoinHouseholdScreen({
  route,
  navigation,
}: // eslint-disable-next-line @typescript-eslint/no-unused-vars
NativeStackScreenProps<RootStackParamList, "RequestToJoinHousehold">) {
  ...
  useEffect(() => {
    (async function getHousehold() {
      ...
      const response = await fetch(
        "https://household-backend.azurewebsites.net/api/V01/profile/GetByHouseholdId/" +
