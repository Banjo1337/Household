...
export default function ThemeProvider({ children }: Props) {
  ...
  const [systemTheme, setSystemTheme] = useSecureStorage<boolean>("autoTheme", true);
  ...
  return <ThemeContext.Provider value={{ darkmode, setDarkmode, systemTheme, setSystemTheme, currentTheme, setCurrentTheme }}>{children}</ThemeContext.Provider>;
}
